			...
			createDateTimePicker = function (input) {
			    ...
			    datetimepicker
					.on('xchange.xdsoft', function (event) {
					    ...
					    // console.log(options.timeslenght);
					    // generate timebox
					    var time = '',
							h = '',
							m = '',
					    ...
					    timeslenght = options.timeslenght;

					    if (!options.allowTimes || !$.isArray(options.allowTimes) || !options.timeslenght) {
